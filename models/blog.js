...
const blogSchema = new Schema({
  ...
  ext_oficina: { type: String, required: true },
  telefono_habitacion: { type: String, required: true },
  apdo_habitacion: { type: String, required: true },
  medico: { type: String, required: true },
  emergencia: { type: String, required: true },
  parentesco: { type: String, required: true },
  telefono_parentesco: { type: String, required: true }
});

// Export Module/Schema
module.exports = mongoose.model('Patients', blogSchema);
